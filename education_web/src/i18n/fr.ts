...
const en = {
  ...
  'device': {
    ...
    'is_look': 'Vouc pouvez voir l\'écran?',
    'no': 'Non',
    'yes': 'Oui',
    'is_hear': 'Can you hear the music while the music is playing?',
    'click_play': 'Tester votre haut parleur',
  ...
  'home': {
    ...
    'room_name': 'Titre de votre cours',
    'nickname': 'Votre nom',
    'room_type': 'Type de la session',
    'room_join': 'Démarrer la session',
    'short_title': {
      'setup': 'Setup',
      'title': 'Edum',
      'subtitle': 'Platform de viso conférnce orientée Education',
    },
    'name_too_long': 'name too long, should <= 20 characters',
    '1v1': 'Face à face',
    'mini_class': 'Classe de petite taille',
    'large_class': 'Class de grande taille',
    'super_mini_class': 'Mini classe',
    'missing_room_name': 'Titre du cours est obligatoire',
    'missing_your_name': 'Le nom est obligatoire',
    'missing_password': 'missing password',
    'missing_role': 'Veuillez Choisir le role',
    'account': 'Name',
    'password': 'Password',
  },
  'room': {
